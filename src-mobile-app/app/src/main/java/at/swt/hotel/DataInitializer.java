...
public class DataInitializer extends AppCompatActivity {
    ...
    private void initBasicData() {
        ...
        HotelRating ratingHotel2 = new HotelRating();
        ...
        HotelInterest activityHotel4_1 = new HotelInterest();
        activityHotel3_1.type = "Fitnesscenter";
        activityHotel3_1.description = "Fitnesscenter";

        HotelInterest activityHotel4_2 = new HotelInterest();
